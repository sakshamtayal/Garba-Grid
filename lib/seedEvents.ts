...
// All dates set to first day of the event at 7 PM IST (UTC+5:30 = UTC+13:30:00 offset → subtract 5:30 → UTC 13:30)
...
export async function seedEvents(): Promise<{ inserted: number; skipped: number }> {
  ...
  console.log(`Seeded ${inserted} events, ${skipped} already existed`);
